<template>
    <div class="index">
        ...
        <div class="section" v-for="(item, index) in goodlist" :key="item.levellcateid">
            <div class="main-tit">
                <h2>{{item.catetitle}}</h2>
                <p>
                    <a href="/goods/43.html" v-for="(itemSon, index) in item.level2catelist" :key="itemSon.subcateid">手机通讯</a>
